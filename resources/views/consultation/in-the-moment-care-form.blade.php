                ...
                <div class="col-lg-6">
                    ...
                    <div class="card support-card p-4">
                        ...
                        <ul class="list-unstyled">
                            ...
                            <li><span class="check_circle"><i class="fas fa-check-circle"></i></span>You would like to discuss an idea, thought, or concern.</li>

							

                            <li><span class="check_circle"><i class="fas fa-check-circle"></i></span>You just need to talk.</li>
