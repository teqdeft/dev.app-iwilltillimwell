   ...
   <body style="font-family: 'open sans', 'helvetica neue', sans-serif;">
            ...
            <div class="main-body-content" style="padding: 15px 30px;">
               <div class="inner-main-body-content">
                  <div class="intro-text-box">
                     <h4><span>Dear {{ $influencerName }},</span></h4>
                     <p style="line-height: 1.5;">Welcome to iWILL ‘til i’mWELL. As a affilate, you can access your dashboard.

                     </p>
                     <div class="newsletter-box">
                    <h4> To get started please follow the link below :</h4>
                  <h4> <a href="{{env('APP_URL')}}/login" target="_blank" style="color: #994c8d;">{{env('APP_URL')}}/login</a></h4>
                    <table style="border-collapse: collapse;width: 100%;text-align:left;">

                              <tr>
                                <th style="  border: 1px solid #ddd;padding: 8px 20px;">User Name</th>
                                <td style="  border: 1px solid #ddd;padding: 8px 20px;">{{ $influencerEmail }}</td>
                              </tr>
                              <tr>
                                <th style="  border: 1px solid #ddd;padding: 8px 20px;">Password</th>
                                <td style="  border: 1px solid #ddd;padding: 8px 20px;">{{ $influencerPassword }}</td>
                              </tr>
                     ...
                     <p style="line-height: 1.5;">Your account is activated. You will have
                        access to view your transactions.
                     </p>
    ...
    font-weight: 600;">support@iwilltilimwell.com.</a></p>
            ...
            <div class="footer" style="    background: #994c8d;color: #fff;padding: 24px;text-align: center;">
               ...
               <p style="line-height: 1.5;font-size:12px;text-align: center;margin-bottom:25px;">© <?= date('Y') ?> iWILL ‘til i’mWELL. All rights reserved.
