...
.calendar_default_selected{
    background: rgb(191 188 188) !important;
}
</style>
...
<div class="banner-sec information-banner inner-main-banner group-counseling-banner">
   <div class="cust-container">
      <div class="banner-cont">
         ...
         <h4 class=" wow fadeInUp animated text-white">All groups will be held remotely</h4>
      </div>
   </div>
</div>
<section class="information-sec register-group-counseling">

   <div class="cust-container">
      <div class="consent-forms-contents theme-white-bg theme-pxy-50 theme-border-radius">
         <h2 class="theme-heading-text fs-30 lh-1-4">Register here for Group Counseling</h2>
         <div class=" mb-5 gc-main-container">
           @if (session('message'))
           ...
           <div class="group-container">
             <div class="first-counseling-step">
               <div style="float:left; width: 213px;z-index: 2;">
                   <div id="nav"></div>
               </div>
               <div id="dp" allDataGet="{{ json_encode($counselorData) }}" ?></div>
             </div>
             <div class="second-counseling-step" style="display:none;">
               @include('counseling.group-counseling-form')
             </div>
              <div class="form-group next-step-button" style="display:none;">
            ...
            <div class="col-sm-12">
               <div class="content-inner-box">
                  <div class="wow fadeInUp  animated" style="visibility: visible; animation-name: fadeInUp;">
                     <h2 class="theme-heading-text fs-30 lh-1-4">What is Group Counseling?</h2>
                  </div>
         ...
         <div class="content-box-main wow fadeInUp  mt-3 animated" style="visibility: visible; animation-name: fadeInUp;">
            <h2 class="theme-heading-text fs-30 lh-1-4">Group Counseling Guidelines</h2>
         ...
         <div class="content-box-main wow fadeInUp  mt-4 animated" style="visibility: visible; animation-name: fadeInUp;">
            ...
            <p><strong>NOTE: </strong> If desired, any group can be offered in combination with a gospel-centered approach. If that is your interest, please send your request to <a href="mailto:iwilltilimwell@gmail.com">iwilltilimwell@gmail.com</a>. We will work to construct the group with a minimum of six members.</p>
         </div>
