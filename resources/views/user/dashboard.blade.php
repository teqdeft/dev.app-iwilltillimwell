...
document.addEventListener("DOMContentLoaded", function () {
    document.getElementById("newAffirmationBtn").addEventListener("click", function () {
		showLoaderPageLoad("show");
		console.log("newAffirmationBtn");
        fetch("{{ route('get.next.affirmation') }}")
        .then(response => response.json())
        .then(data => {
            document.getElementById("affirmationMessage").innerText = data.message;
...
}setTimeout(function() {    getLatestDashConsult();}, 500);
</script>
