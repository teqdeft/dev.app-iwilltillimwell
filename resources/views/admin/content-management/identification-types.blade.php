...
@section('title', trans('labels.identification_types'))
...
<div class="dashboard-right cust-dashboard-md-right">
    ...
    <div class="invoice-container">
        <h2>{{ __('labels.identification_types') }}</h2>
            ...
            <div class="tab-content">
                <div class="tab-pane active">
                    <div class="list-table-custom  products-table">
                        <table class="table table-striped" id="identification-types-list-table">
                            <thead>
                                <tr>
                            ...
                            @forelse ($identificationTypes as $identificationType)
                                <tr>
                                    <td>{{ $identificationType->getTranslation('name', 'en') }}</td>
                                    <td>{{ $identificationType->getTranslation('name', 'es') }}</td>
                                    <td class="to-show">
                                        <div class="inner-to-show">
                                            ...
                                            <div class="dropdown-menu">
                                                <ul>
                                                    <li><a href="{{route('identification_type_edit_update', $identificationType)}}">{{ __('labels.edit') }}</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </td>
