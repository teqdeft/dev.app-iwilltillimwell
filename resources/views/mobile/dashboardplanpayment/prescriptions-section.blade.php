<div class="dash-section">
                ...
                <div class="dash-row pres-mobile-v1">
                    
					<a href="{{url('prescriptions-a-type')}}" class="showLoaderPageLoad">
...
@endphp							
					...
					<a href="{{url('prescriptions-b-type')}}" class="showLoaderPageLoad">
                        <div class="dash-menu-card ">
                            <div class="icon">
                                <svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
...
@endphp							
                            <div class="title">
                                <p>Gold Prescription Plan</p>
                            </div>
                        </div>
                    </a>
					
					
					<a href="{{url('prescriptions-c-type')}}" class="showLoaderPageLoad">
                        <div class="dash-menu-card ">
                            <div class="icon">
                               <svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
										<rect x="11" y="12" width="34.5243" height="34.5242" rx="17.2621" fill="#EEEFF4"/>
                            ...
                            <div class="title">
                                <p>Platinum Prescription Plan</p>
                            </div>
                        </div>
                    </a>
					
					
					<a href="javascript:void(0)" class="open-modal" data-modal="prescription-search-modal" onclick="prescriptionsearchmodal()">
                        <div class="dash-menu-card ">
                            <div class="icon">
							
                               <svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
								<rect x="11" y="12" width="34.5243" height="34.5242" rx="17.2621" fill="#EEEFF4"/>
								<g clip-path="url(#clip0_3401_109)">
								<path d="M31.0605 20.3862C32.1445 20.7371 33.0102 21.1872 33.6055 21.689C34.2508 22.2329 34.5172 22.7794 34.5176 23.269L34.5098 23.4175C34.4264 24.1668 33.7125 25.0211 32.1699 25.7261C30.5614 26.4612 28.345 26.8863 26.0078 26.8862C25.5327 26.8853 25.0596 26.8644 24.5928 26.8286L31.0605 20.3862ZM26.0078 19.6499C26.817 19.65 27.6195 19.7014 28.3926 19.8013L21.7881 26.3794C20.468 26.0474 19.3864 25.5741 18.6367 25.0181C17.8352 24.4236 17.503 23.8109 17.499 23.269C17.4989 22.8809 17.6642 22.4601 18.0547 22.0288C18.4484 21.5942 19.0489 21.175 19.8447 20.811C20.6379 20.4484 21.5919 20.1556 22.6533 19.9546C23.7137 19.7538 24.854 19.6499 26.0078 19.6499Z" stroke="#8462A8"/>
								<path d="M34.5176 27.7551C34.5176 28.5772 33.7666 29.4839 32.1709 30.2131C30.6194 30.9222 28.4407 31.3733 26.0078 31.3733C23.5751 31.3733 21.3969 30.9221 19.8457 30.2131C18.2504 29.4839 17.499 28.5773 17.499 27.7551V27.0383C17.9282 27.3315 18.3948 27.589 18.8906 27.8157C20.827 28.7008 23.3051 29.1838 26.0078 29.1838C28.7105 29.1838 31.1887 28.7008 33.125 27.8157C33.6211 27.5889 34.0883 27.3317 34.5176 27.0383V27.7551Z" stroke="#8462A8"/>
								<path d="M14.4326 19.3904L9.7168 24.5876C7.75049 26.7546 4.43858 26.941 2.26367 24.9919C0.0858975 23.0401 -0.101916 19.7138 1.8584 17.5535L6.5791 12.3503L14.4326 19.3904ZM17.042 3.64722C18.2199 3.69512 19.3887 4.13883 20.3418 4.99292C22.5197 6.94471 22.7074 10.272 20.7471 12.4324L16.0273 17.6335L8.17188 10.5945L12.8887 5.39722H12.8896C13.996 4.17822 15.5266 3.58564 17.042 3.64722ZM14.9248 5.97241C14.6078 5.96919 14.3243 6.1104 14.0967 6.33569L14.0918 6.34155L14.0859 6.34644L11.7539 8.80054C11.3167 9.26002 11.3344 9.9874 11.7939 10.4246V10.4236C12.2248 10.8337 12.8912 10.8439 13.333 10.4646L13.418 10.3835L15.751 7.92847C16.1868 7.46927 16.169 6.74337 15.7109 6.3064L15.6992 6.29663L15.5371 6.17065C15.3637 6.05515 15.157 5.97488 14.9248 5.97241Z" stroke="#8462A8"/>
								</g>
								<defs>
								<clipPath id="clip0_3401_109">
